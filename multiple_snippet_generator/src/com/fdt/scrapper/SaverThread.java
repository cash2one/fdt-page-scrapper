...
public class SaverThread extends Thread
{
	...
	public SaverThread(TaskFactory taskFactory) {
		super();
	...
	public void saveKeys(ArrayList<String> keys){
		...
		try {
			restKeysFile = new File("rest_" + ConfigManager.getInstance().getProperty(MultipleSnippetGeneratorRunner.KEY_WORDS_FILE_PATH_LABEL));
			restKeysFileNew = new File("new_rest_" + ConfigManager.getInstance().getProperty(MultipleSnippetGeneratorRunner.KEY_WORDS_FILE_PATH_LABEL));

			if(!restKeysFile.exists()){
				File keysFile = new File(ConfigManager.getInstance().getProperty(MultipleSnippetGeneratorRunner.KEY_WORDS_FILE_PATH_LABEL));
