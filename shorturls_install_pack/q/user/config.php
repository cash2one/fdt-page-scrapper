...
define( 'YOURLS_DB_USER', 'intheq' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'warcraft' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'intheq' );
...
/** MySQL tables prefix */
define( 'YOURLS_DB_PREFIX', 'intheq_' );
...
define( 'YOURLS_SITE', 'http://intheq.com' );
...
define( 'YOURLS_COOKIEKEY', '897979dGFD234fdsfFSD808sfs07SFD' );
