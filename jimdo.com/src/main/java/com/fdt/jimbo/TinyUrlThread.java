...
public class TinyUrlThread extends Thread{
	...
	public TinyUrlThread(TinyUrlTask task, TinyUrlTaskFactory taskFactory, ProxyFactory proxyFactory, String listProcessedFilePath, String downloadUrl) {
		this.task = task;
		...
		synchronized (this) {
			try{
				...
				try {
					...
					String tinyUrl = getTinyUrl(downloadUrl, proxyConnector.getConnect(proxyFactory.getProxyType()));
