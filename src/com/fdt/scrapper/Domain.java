...
public class Domain {
    ...
    private HashMap<String, Integer> subDomainsIndexList = new HashMap<String, Integer>();
    private ArrayList<Domain> subDomainsList = new ArrayList<Domain>();
	...
	if(subDomainsIndexList.containsKey(subDomain)){
	    ...
	    subDomainsList.add(new Domain(subDomain));
