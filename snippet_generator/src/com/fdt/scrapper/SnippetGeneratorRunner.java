...
public class SnippetGeneratorRunner{
	...
	if(args.length < 3){
		...
		SnippetGeneratorThread generator = new SnippetGeneratorThread(ConfigManager.getInstance().getProperty(LINKS_LIST_FILE_PATH_LABEL),ConfigManager.getInstance().getProperty(PROXY_LIST_FILE_PATH_LABEL),args);
