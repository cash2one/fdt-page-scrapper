...
$mypage404=false; //если true, то статус 404, иначе просто пуста€ страничка.
...
// провер€ем полученный GET-параметр
if(isset($_GET['id'])){
...
<title>—траница не найдена!</title>
</head>
<body>
<h1>—траница не найдена! 404 ошибка.</h1>
<br><br>
¬ернитесь на главную страницу сайта или воспользуйтесь поиском!
</body></html>
END;
}else{
echo <<<END
...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=windows-1251" />
<title>ѕартнерские ссылки</title>
</head>
<body>
END;
echo $strLink;
