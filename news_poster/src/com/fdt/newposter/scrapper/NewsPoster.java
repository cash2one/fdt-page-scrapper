...
import com.fdt.newposter.scrapper.task.Constants;
import com.fdt.newposter.scrapper.task.NewsTask;
import com.fdt.newposter.scrapper.task.Snippet;
...
public class NewsPoster {
	...
	private String postNews(ArrayList<Snippet> snippets){
	    ...
	    conn.setRequestProperty("Cookie", account.getCookie());*/
			...
			groupUrl = Constants.getInstance().getProperty(AccountFactory.MAIN_URL_NEW_LABEL)+"/"+groupUrl + "/";
