...
public class PostbitNewsPoster {
	...
	private void login() throws Exception{
		...
		try {
			...
			conn.addRequestProperty("Host", "manager.e-monsite.com");
			conn.addRequestProperty("Accept", "*/*");	
			conn.addRequestProperty("Referer", "http://manager.e-monsite.com/sessions/start");
			...
			//httppost.setHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8"); 
			List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
			nameValuePairs.add(new BasicNameValuePair("login_or_email","uritasthau"));
			nameValuePairs.add(new BasicNameValuePair("passwd","1bWf0Cq"));
	...
	private void post(ArrayList<Snippet> snippets) throws Exception{
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("publish_from_d","17"));
			...
			nameValuePairs.add(new BasicNameValuePair("seo_uri_fr","keyword1"));
